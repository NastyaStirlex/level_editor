...
import com.delmesoft.editor2d.utils.ArrayUtils;
...
public class BucketTool implements Tool {
	...
	public void touchDragged(Editor editor) {
		...
		if(model.size() > 0) {
			...
			ArrayUtils.floodfill(layer.tileData, editor.mapWidth, editor.mapHeight, editor.currentTile / editor.mapHeight, editor.currentTile % editor.mapHeight, levelEditor.tilesetPanel.selectedTile + 1);
